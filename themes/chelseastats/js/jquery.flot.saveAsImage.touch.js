...
Usage:
    ...
    <script type="text/javascript" src="http://zizhujy.com/Scripts/flot/jquery.flot.saveAsImage.touch.js"></script>
...
; (function ($, Canvas2Image) {
    ...
    function init(plot, classes) {
        ...
        function bindEvents(plot, eventHolder) {
            eventHolder.touchstart(onTouchStart);
        }
    ...
    function createImageFromCanvas(canvas, plot, format) {
        ...
        if (!img) {
            alert(plot.getOptions().notSupportMessage || "Oh Sorry, please use PRINT SCREEN key instead!");
            return false;
        }
