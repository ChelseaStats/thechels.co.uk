<?php /*  Template Name: # D TBL EPL 1G */ ?>
<?php get_header(); ?>
<div id="content">
	<div id="contentleft">
		<h4 class="special"><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h4>
		<p>Premier League full time records based on scoring or conceding the game's first goal.</p>
		<P>Historically around 70% of teams that score go on to win the game.</P>
