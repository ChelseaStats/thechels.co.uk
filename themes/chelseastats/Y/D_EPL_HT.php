<?php /*  Template Name: # D TBL EPL HT */ ?>
<?php get_header(); ?>
<div id="content">
	<div id="contentleft">
		<h4 class="special"><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h4>
		<p>Premier League full time records based on result situation at half-time.</p>
