<?php /* Template Name: # i progress configs */ ?>
<?php get_header(); ?>
		...
		<div id="contentleft">
			...
			<?php
				...
				if ( isset($v01) && $v01!=="" && isset($v02) && $v02!=="") {
						...
						try {
							$pdo = new pdodb();
							$pdo->query("INSERT INTO 000_configs (F_FIELD, F_VALUE) VALUES (:v1, :v2) on DUPLICATE KEY UPDATE F_VALUE = :v2");
							$pdo->bind(':v1' ,$v01);
							$pdo->bind(':v2' ,$v02);
			...
			<?php
				//================================================================================
				$sql = "select F_FIELD as N_NAME, F_VALUE from 000_configs order by F_ID asc";
