<?php /* Template Name: # m-T5 home by*/ ?>
<?php get_header(); ?>
<?php if (current_user_can('level_10')) : ?>
	<div id="content">
		<div id="contentleft">
			...
			<p>top 5 away teams beaten by the home team given</p>
			<?php
				...
				if (isset($team) && $team !='')  {
					...
					$pdo = new pdodb();
					$pdo->query('SELECT F_AWAY N, count(*) as V FROM all_results WHERE F_HGOALS > F_AGOALS AND F_HOME =:team
					...
					$team = $go->_V($team);
					$message ="#Stats Top 5 most PL wins at home by ".$team.": ".$nv;
