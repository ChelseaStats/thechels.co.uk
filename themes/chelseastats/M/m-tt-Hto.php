<?php /* Template Name: # m-T5 home to*/ ?>
<?php get_header(); ?>
<?php if (current_user_can('level_10')) : ?>
	<div id="content">
		<div id="contentleft">
			...
			<p>Top 5 home teams by wins against given away team</p>
			<?php
				...
				if (isset($team) && $team !='')  {
					...
					$pdo = new pdodb();
					$pdo->query('SELECT F_HOME N, count(*) as V FROM all_results WHERE F_HGOALS > F_AGOALS AND F_AWAY =:team
					...
					$team = $go->_V($team);
					$message ="#Stats Top 5 most PL wins in games at home to ".$team.": ".$nv;
